...
CREATE TABLE `tblturma` (
  ...
  `strSigla` varchar(7) NOT NULL,
  `enumDia` enum('Segunda','Terça','Quarta','Quinta','Sexta','Sábado','Domingo') DEFAULT NULL,
  `enumPeriodo` enum('Matutino','Vespertino','Noturno') DEFAULT NULL,
  ...
  KEY `fkChave` (`fkChave`),
  KEY `idx_tblturma_upkChave` (`upkChave`)
